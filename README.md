...
List of practical problems along with solutions which can be solved in any programming languages.

## Contribution

If you want to contribute to this repository, please see the following instructions:
- Create a folder with programming language name in which you will provide the solutions.
- For each problem, create a folder with problem name and put your solution under that folder.
- Create a separate branch (ideally with your name) and send a PR.

## Table of Contents

- [Numbers](https://github.com/saadii/ProjectSolutions#numbers)
- [Classic Algorithms](https://github.com/saadii/ProjectSolutions#classic-algorithms)
- [Graph](https://github.com/saadii/ProjectSolutions#graph)
- [Data Structures](https://github.com/saadii/ProjectSolutions#data-structures)
- [Text](https://github.com/saadii/ProjectSolutions#text)
- [Networking](https://github.com/saadii/ProjectSolutions#networking)
- [Classes](https://github.com/saadii/ProjectSolutions#classes)
- [Threading](https://github.com/saadii/ProjectSolutions#threading)
- [Web](https://github.com/saadii/ProjectSolutions#web)
- [Files](https://github.com/saadii/ProjectSolutions#files)
- [Databases](https://github.com/saadii/ProjectSolutions#databases)
- [Graphics and Multimedia](https://github.com/saadii/ProjectSolutions#graphics-and-multimedia)
- [Security](https://github.com/saadii/ProjectSolutions#security)
